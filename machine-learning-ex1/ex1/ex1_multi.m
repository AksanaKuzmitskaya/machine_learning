...
plot(1:50, J_history2(1:50), 'k');
plot(1:50, J_history3(1:50), 'g');
plot(1:50, J_history4(1:50), 'y');
plot(1:50, J_history5(1:50), 'c');
...
x1 = (1650 - mu(1,1))/sigma(1,1); % normilized size
x2 = (3 - mu(1,2))/sigma(1,2); % normilized br
...
fprintf('Program paused. Pss enter to continue.\n');
pause;
